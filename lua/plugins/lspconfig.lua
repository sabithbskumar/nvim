    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(event)
          ...
          --  For example, in C this would go to the header.
          ...
          -- Create a keymap to toggle inlay hints in the code,
          -- if the language server supports them
          --
      ...
      require("mason-lspconfig").setup({
        handlers = {
          function(server_name)
            ...
            -- Overriding only values explicitly passed
